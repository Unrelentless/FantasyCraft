...
public class ModelNirvana extends AdvancedModelLoader
{
	...
	public ModelNirvana()
	{
		modelBusterSword = AdvancedModelLoader.loadModel(new ResourceLocation(FantasyCraft.MODID+":models/Nirvana.obj"));
	}
	public void render()
	{
