package com.unrelentless.fcraft.network;
...
import com.unrelentless.fcraft.network.packet.bidirectional.AbstractBiMessageHandler;
import com.unrelentless.fcraft.network.packet.bidirectional.PlaySoundPacket;
import com.unrelentless.fcraft.network.packet.client.SyncPlayerPropsMessage;
import com.unrelentless.fcraft.network.packet.server.AbstractServerMessageHandler;
...
public class PacketDispatcher
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(FantasyCraft.MODID);
	/**
	 ...
	 * @param handlerClass Must extend one of {@link AbstractServerMessageHandler}, {@link AbstractServerMessageHandler}, or {@link AbstractBiMessageHandler}
	 */
